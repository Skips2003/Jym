(() => {
  // node_modules/body-highlighter/dist/body-highlighter.esm.js
  var e = {
    TRAPEZIUS: "trapezius",
  ...
  var T = {
    trapezius: e.UPPER_BACK,
    "upper trapezius": e.UPPER_BACK,
    rhomboids: e.UPPER_BACK,
    "levator scapulae": e.UPPER_BACK,
    "erector spinae": e.LOWER_BACK,
    "pectoralis major": e.CHEST,
    "rectus abdominis": e.ABS,
    "transverse abdominis": e.ABS,
    obliques: e.OBLIQUES,
    "serratus anterior": e.ABS,
    "anterior deltoids": e.FRONT_DELTOIDS,
    "medial deltoids": e.FRONT_DELTOIDS,
    "lateral deltoids": e.FRONT_DELTOIDS,
    "posterior deltoids": e.BACK_DELTOIDS,
    infraspinatus: e.BACK_DELTOIDS,
    "teres minor": e.BACK_DELTOIDS,
    "teres major": e.BACK_DELTOIDS,
    supraspinatus: e.BACK_DELTOIDS,
    subscapularis: e.BACK_DELTOIDS,
    "biceps brachii": e.BICEPS,
    brachialis: e.BICEPS,
    brachioradialis: e.BICEPS,
    "triceps brachii": e.TRICEPS,
    "flexor carpi radialis": e.FOREARM,
    anconeus: e.FOREARM,
    "gluteus maximus": e.GLUTEAL,
    "gluteus medius": e.GLUTEAL,
    "gluteus minimus": e.GLUTEAL,
    "rectus femoris": e.QUADRICEPS,
    "quadriceps femoris": e.QUADRICEPS,
    "vastus medialis": e.QUADRICEPS,
    "biceps femoris": e.HAMSTRING,
    "adductor magnus": e.ABDUCTOR,
    "tensor fasciae latae": e.ABDUCTORS,
    abductors: e.ABDUCTORS,
    gastrocnemius: e.CALVES,
    soleus: e.CALVES,
    "tibialis anterior": e.CALVES,
    "tibialis posterior": e.CALVES,
    "extensor hallucis longus": e.CALVES,
    "extensor digitorum longus": e.CALVES
  };
  var v = "#B6BDC3";
  var R = ["#81b1d9", "#277abf"];
  var D = m.ANTERIOR;
  var O = (r, s) => r == null ? s : r;
  var E = new Set(Object.values(e));
  var A = (r) => {
    if (E.has(r))
      return r;
    if (typeof r != "string")
  ...
  var b = (r, s, t) => {
    var n;
    const i = (n = r[t]) == null ? void 0 : n.frequency;
    if (!(i == null || i === 0))
      return s[Math.min(s.length - 1, i - 1)];
  };
  var I = (r) => r.reduce((s, t) => {
    for (const i of t.muscles) {
      const n = A(i);
      n && (s[n].exercises = [...s[n].exercises, t.name], s[n].frequency += t.frequency || 1);
    }
    return s;
  }, JSON.parse(JSON.stringify(L)));
  var f = "http://www.w3.org/2000/svg";
  var c = "rbh-wrapper";
  var B = (r) => r.replace(/[A-Z]/g, (s) => `-${s.toLowerCase()}`).replace(/^ms-/, "-ms-");
  var C = (r, s) => {
    if (r.removeAttribute("style"), !!s)
      for (const [t, i] of Object.entries(s))
        i != null && r.style.setProperty(B(t), String(i));
  };
  var S = (r, s) => {
    for (; r.firstChild; )
  ...
  var U = (r = {}) => {
    var s, t, i, n, l;
    return {
      bodyColor: (s = r.bodyColor) != null ? s : v,
      data: (t = r.data) != null ? t : [],
      highlightedColors: r.highlightedColors ? [...r.highlightedColors] : [...R],
      onClick: r.onClick,
      container: (i = r.container) != null ? i : null,
      wrapperClassName: (n = r.wrapperClassName) != null ? n : c,
      style: r.style,
      svgStyle: r.svgStyle,
      type: (l = r.type) != null ? l : D
    };
  };
  var _ = (r) => r === m.ANTERIOR ? P : p;
  var h = (r, s, t, i, n) => {
    const l = document.createElementNS(f, "polygon");
    return l.setAttribute("points", s.trim()), l.style.cursor = "pointer", l.style.fill = t, i && n && l.addEventListener("click", () => {
      i({ muscle: r, data: n[r] });
    }), l;
  };
  var K = (r) => {
    const s = U(r), t = document.createElement("div");
    t.className = s.wrapperClassName || c;
    const i = document.createElementNS(f, "svg");
    i.classList.add("rbh"), i.setAttribute("width", "100%"), i.setAttribute("height", "100%"), i.setAttribute("viewBox", "0 0 100 200");
    const n = () => {
      const o = I([...s.data]), g = _(s.type).flatMap(
        (u) => u.svgPoints.map(
          (y) => h(
            u.muscle,
            y,
            O(b(o, s.highlightedColors, u.muscle), s.bodyColor),
            s.onClick,
            o
          )
        )
      ...
      s.container && t.parentElement !== s.container && s.container.appendChild(t);
    }, d = () => {
      C(t, s.style), C(i, s.svgStyle);
    };
    return t.appendChild(i), d(), n(), l(), {
      element: t,
      update: (o) => {
        var a;
        o && (o.bodyColor !== void 0 && (s.bodyColor = o.bodyColor), o.data !== void 0 && (s.data = o.data), o.highlightedColors !== void 0 && (s.highlightedColors = o.highlightedColors ? [...o.highlightedColors] : []), o.onClick !== void 0 && (s.onClick = o.onClick), o.container !== void 0 && (s.container = o.container, s.container ? l() : t.parentNode && t.parentNode.removeChild(t)), o.wrapperClassName !== void 0 && (s.wrapperClassName = (a = o.wrapperClassName) != null ? a : c, t.className = s.wrapperClassName || c), o.style !== void 0 && (s.style = o.style), o.svgStyle !== void 0 && (s.svgStyle = o.svgStyle), o.type !== void 0 && (s.type = o.type), d(), n(), s.container && l());
      },
      destroy: () => {
        S(i, []), t.parentNode && t.parentNode.removeChild(t);
      }
    };
  };
